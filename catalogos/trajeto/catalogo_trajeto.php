    ...
    <body style="background-color: #00995D">
        ...
        <div class="pikachoose">           
            <div style="text-align: center; margin-top: 20px; margin-left: 350px; z-index: 999999; position: fixed; top: 0px;">
                <font style="color: white"><b><h2>Imagens do Trajeto</h2></b></font>
                <div class="fb-share-button" data-href="http://www.unimed-erechim.com.br/supervoltaunimedmtb/catalogos/trajeto/catalogo_trajeto.php" data-layout="button"></div>
            </div>
